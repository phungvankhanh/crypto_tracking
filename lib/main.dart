...
class CryptoTrackingApp extends StatefulWidget {
  CryptoTrackingApp(this.themeMode, this.darkOLED);
  final themeMode;
  final darkOLED;

  @override
  CryptoTrackingAppState createState() => new CryptoTrackingAppState();
}

class CryptoTrackingAppState extends State<CryptoTrackingApp> {
  bool darkEnabled;
  String themeMode;
  bool darkOLED;
